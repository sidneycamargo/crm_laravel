					  ...
					  <div class="top-menu ms-auto">
						<ul class="navbar-nav align-items-center gap-1">
							...
							<li class="nav-item dropdown dropdown-laungauge d-none d-sm-flex">
								<a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="avascript:;" data-bs-toggle="dropdown"><img src="{{ asset('backend') }}/assets/images/county/09.png" width="22" alt="">
								</a>
								<ul class="dropdown-menu dropdown-menu-end">
									<li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{ asset('backend') }}/assets/images/county/09.png" width="20" alt=""><span class="ms-2">Portugues</span></a>
									</li>
									<li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{ asset('backend') }}/assets/images/county/05.png" width="20" alt=""><span class="ms-2">English</span></a>
									</li>
									<li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{ asset('backend') }}/assets/images/county/03.png" width="20" alt=""><span class="ms-2">Germany</span></a>
									</li>
									<li><a class="dropdown-item d-flex align-items-center py-2" href="javascript:;"><img src="{{ asset('backend') }}/assets/images/county/04.png" width="20" alt=""><span class="ms-2">French</span></a>
									</li>
								</ul>
							</li>
